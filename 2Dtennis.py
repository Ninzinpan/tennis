...
class Bar(pygame.sprite.Sprite):
    ...
    def update(self, dx,dy):  # dyの値（上下方向の移動量）でバーを動かす
        self.rect.x += dx  # バーの現在位置にdyを加算して移動
...
def main():
    ...
    wall1 = Wall(300,100,200,10,3,0)
    wall4 = Wall(500,400,200,10,3,0)
    ...
    while running:
        ...
        # バーとボールの位置を更新
        bar1.update(bar1_dx,bar1_dy)
        bar2.update(bar2_dx,bar2_dy)
        ball.update()
        walls.update()
